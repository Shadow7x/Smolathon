...
const ActivityCard = ({
  ...
  return (
    <div
      className="text-black flex flex-col justify-between px-5 py-10 border-1 border-[#e9e9e9] rounded-2xl h-[400px]"
      style={{ width }}
    >
      <span className="text-start font-bold text-3xl md:text-4xl lg:text-[48px] leading-tight">
        {title}
      </span>
      <div className="w-full text-[#636363] flex flex-row justify-between items-end gap-4 lg:gap-16 mt-4">
        <span className="text-lg md:text-xl lg:text-[24px] leading-tight flex-1">
          {description}
        </span>
        <div className="p-4 flex-shrink-0">{icon}</div>
      </div>
    </div>
  );
};
...
const ThirdSection = forwardRef<HTMLDivElement>((props, ref) => {
  ...
  const infrastructureIcon = (
    <svg width="120" height="136" viewBox="0 0 120 136" fill="none">
      <path
    ...
    [
      {
        ...
        description:
          "Внедрение и обслуживание комплексов автоматической фотовидеофиксации нарушений ПДД",
        icon: securityIcon,
        width: "60%",
      },
      {
        ...
        description:
          "Установка и содержание дорожных знаков, нанесение разметки, строительство и модернизация светофорных объектов",
    ...
    [
      {
        ...
        description:
          "Развитие автоматизированных систем управления дорожным движением для адаптивного управления светофорами",
      ...
      },
      {
        ...
        description:
          "Проектирование схем организации движения, мониторинг трафика и моделирование для повышения пропускной способности дорог",
  ...
  return (
    <div ref={ref} className="w-full">
      <div className="flex flex-col justify-center items-center gap-8 sm:gap-12 lg:gap-16 py-8 sm:py-12 lg:py-[100px] px-4 sm:px-6 md:px-8 lg:px-16 xl:px-[200px]">
        <div className="text-[#62A744] font-bold text-4xl sm:text-5xl md:text-6xl lg:text-[64px] text-center">
