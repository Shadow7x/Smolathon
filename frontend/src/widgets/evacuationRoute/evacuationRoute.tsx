...
export default function EvacuationRoutePage() {
  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pt-[8rem]">
      ...
      <Card className="w-full">
        <CardContent>
          {showTable ? (
            ...
            <div className="w-full min-h-[200px] flex flex-col items-center justify-center text-gray-400 px-6">
