...
// ленивый импорт SwithCar
const SwithCar = React.lazy(() => import("../swithmap/swith_car_detectors"));
...
export default function WorkloadUpload({ yearFilter, fetchWorkloads, fetchAllWorkloads }: any) {
  ...
  return (
    <div className="p-2 w-full max-w-[700px] mx-auto">
      {/* Верхняя панель */}
      <div className="flex justify-between items-center">
        {/* Левая часть */}
        <div className="flex items-center gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 66 66" width="26" height="26" fill="currentColor">
        ...
        <div className="flex gap-2 flex-col items-center">
          <button
            ...
            className="flex items-center gap-2 bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium px-3 py-1.5 rounded-md transition"
          >
          ...
          <button
            ...
            className="flex justify-center items-center gap-2 bg-gray-800 hover:bg-gray-700 text-white text-sm font-medium w-[120px] py-1.5 rounded-md transition disabled:opacity-60"
          >
        ...
        {/* Ленивый компонент */}
        <Suspense fallback={<div className="text-sm text-gray-500">Загрузка переключателя...</div>}>
          <SwithCar />
        </Suspense>
      </div>
