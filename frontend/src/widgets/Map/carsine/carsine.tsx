...
import InfoCarts from "../infocarts/InsoCarts";
...
export default function Carsine({
  ...
  const [secondInterval, setSecondInterval] = useState<[number, number]>([0, 24]);
  ...
  const handleSelect = (name: string) => {
    ...
    if (selectedCar) setSelectCar(selectedCar);
    else setSelectCar(null);
  ...
  return (
    <div className="mb-6 relative w-full">
      ...
      {isAccompaniment ? (
        <div className="flex flex-col lg:flex-row flex-wrap mt-4 gap-8 md:gap-14">
          {/* Первый слайдер */}
          <div className="flex flex-col gap-3 min-w-[18rem] w-full lg:w-auto">
            <p className="text-sm sm:text-base">Выберите временной интервал</p>
            <div className="flex flex-row w-full sm:w-[38rem] max-w-full h-[2rem]">
              <DoubleHourSlider
          ...
          <div className="flex flex-col gap-3 min-w-[18rem] w-full lg:w-auto">
            <div className="flex flex-row gap-2 items-center">
              ...
              <p className="text-sm sm:text-base">Добавить сравнение</p>
            </div>

            <div
              className={cn(
                "flex flex-row w-full sm:w-[38rem] max-w-full h-[2rem]",
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-10 mt-6 w-full max-w-[1400px] items-start">
            ...
            <div className="relative flex flex-col w-full sm:w-72 md:w-80">
              <CustomInput
                ...
                icon={<Search className="absolute right-5 text-gray-600 w-4 h-4" />}
              />
            ...
            {/* Фильтры */}
            <div className="flex flex-col gap-3">
              <p className="mb-2 font-semibold text-base sm:text-lg">Фильтрация</p>
