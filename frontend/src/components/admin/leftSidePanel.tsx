      ...
      <CardContent className={`${menuItemClass} group`}>
        ...
        <CardContent className={`${menuItemClass} group`}>
          <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M11.0001 21.8332C9.50147 21.8332 8.09314 21.5488 6.77508 20.9801C5.45703 20.4113 4.3105 19.6349 3.3355 18.6509C2.3605 17.6669 1.58862 16.5158 1.01987 15.1978C0.451123 13.8797 0.166748 12.4804 0.166748 10.9999C0.166748 8.16515 1.10564 5.72765 2.98341 3.68737C4.86119 1.64709 7.1723 0.491536 9.91675 0.220703V3.4707C8.05703 3.72348 6.50876 4.55855 5.27196 5.97591C4.03515 7.39327 3.41675 9.06793 3.41675 10.9999C3.41675 13.0943 4.15703 14.8818 5.63758 16.3624C7.11814 17.8429 8.90564 18.5832 11.0001 18.5832C12.1917 18.5832 13.3067 18.3304 14.3449 17.8249C15.3831 17.3193 16.2542 16.6332 16.9584 15.7665L19.7751 17.3915C18.8001 18.7457 17.5452 19.8245 16.0105 20.628C14.4758 21.4315 12.8056 21.8332 11.0001 21.8332ZM20.9126 15.3874L18.0959 13.7624C18.2584 13.329 18.3803 12.8822 18.4615 12.4217C18.5428 11.9613 18.5834 11.4874 18.5834 10.9999C18.5834 9.06793 17.965 7.39327 16.7282 5.97591C15.4914 4.55855 13.9431 3.72348 12.0834 3.4707V0.220703C14.8279 0.491536 17.139 1.64709 19.0167 3.68737C20.8945 5.72765 21.8334 8.16515 21.8334 10.9999C21.8334 11.7943 21.7612 12.5617 21.6167 13.302C21.4723 14.0422 21.2376 14.7374 20.9126 15.3874Z" fill={isActive("/admin/DTP") ? "black" :"#636363"}  className="group-hover:fill-black"  />
          </svg>
          {!isCollapsed && (
            <button
              className={`${isActive("/admin/DTP") ? "text-black" :"text-[#636363]"} group-hover:text-black text-left`}
